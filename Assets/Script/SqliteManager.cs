...
public class SqliteManager: SqliteConnectionManager
{
    ...
    public static void InsertDataIntoWorld(World world)
    {
        Conn.Open();
        if(world != null)
        {
    ...
    public static void UpdateIsCompleteAndToyIntoInsideWorld(int insideWorldId, int isComplete, int achievedToy)
    {
        Conn.Open();
        if (insideWorldId > 0)
        {
    ...
    public static void UpdateIsReadyIntoWorld(int Sl)
    {
        Conn.Open();
        if (Sl > 0)
        {
    ...
    public static void DeleteDataFromWorld(int Sl)
    {
        Conn.Open();
        if (Sl > 0)
        {
    ...
    public static void InsertDataIntoInsideWorld(InsideWorld insideWorld)
    {
        Conn.Open();
        if (insideWorld != null)
        {
